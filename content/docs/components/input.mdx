...
<PropsTable data={[
  { name: "type", type: "string", defaultValue: '"text"', description: "Sets the input type such as text, email, password, or file." },
  { name: "disabled", type: "boolean", defaultValue: "false", description: "Disables the input and prevents user interaction." },
  { name: "className", type: "string", defaultValue: "-", description: "Adds custom classes to adjust layout and styling." }
]} />

Supports all standard native `<input>` attributes.
