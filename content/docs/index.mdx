...
<div className="border-2 border-black bg-white mt-8 hover:bg-main transition-colors duration-200">
    <a href="/docs/installation" className="block p-3 text-right">
        <span className="text-lg font-bold">Installation</span>
        <p className="truncate m-0">Learn how to install Neobrutal UI components</p>
    </a>
</div>