                    ...
                    <div className="grid grid-cols-1 gap-1">
                        {group.items.map((item) => (
                            <Link
                                ...
                                onClick={onLinkClick}
                                className={cn(
                                    "ml-3 block border-l-2 pl-2 py-1 transition-all duration-200 active:scale-[0.97] focus-brutal",
                                    pathname === item.href
            ...
            <div className="sticky top-0 z-40 flex h-12 items-center justify-between border-b-2 border-black bg-main px-6 md:hidden">
                ...
                <div className="flex items-center gap-10">
                    ...
                    <button
                        ...
                        className="focus-brutal transition-all duration-200 active:scale-[0.97] cursor-pointer"
...
export function DocsHeader() {
    ...
    return (
        <header className="container max-w-7xl pt-4 px-6 lg:px-0 flex gap-2 items-center justify-end">
            ...
            <Link href="https://github.com/bridgetamana/neobrutal-ui" target="_blank" className="flex gap-1 items-center focus-brutal border-2 border-black px-3 py-1.5 rounded-base transition-all duration-200 active:scale-[0.97] hover:shadow-brutal-sm">
