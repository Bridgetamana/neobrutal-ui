...
const GITHUB_REPOSITORY_URL = "https://github.com/bridgetamana/neobrutal-ui"
const GITHUB_REPOSITORY_API_URL =
    "https://api.github.com/repos/Bridgetamana/neobrutal-ui"
    ...
    return (
        <header className="container hidden max-w-7xl items-center justify-end gap-2 px-6 pt-4 md:flex lg:px-0">
            ...
            <Link
                ...
                aria-label={
                    starCount === null
                        ? "View Neobrutal UI on GitHub"
                        : `${starCount} GitHub stars`
                }
                className="focus-brutal flex min-h-11 items-center gap-1 rounded-base border-2 border-black px-3 py-1.5 transition-brutal hover:shadow-brutal-sm active:scale-[0.97]"
            >
                <svg
                    aria-hidden="true"
                    focusable="false"
