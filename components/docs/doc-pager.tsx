    ...
    return (
        <nav aria-label="Pagination" className="grid grid-cols-2 gap-3 mt-10">
            {prev ? (
                <Link
                    href={prev.href}
                    className="col-start-1 flex flex-col gap-1 rounded-base border-2 border-black bg-white p-4 shadow-brutal transition-brutal hover:translate-x-[1px] hover:translate-y-[1px] hover:shadow-none focus-brutal"
                >
            ...
            {next && (
                <Link
                    href={next.href}
                    className="col-start-2 flex flex-col gap-1 rounded-base border-2 border-black bg-white p-4 shadow-brutal text-right transition-brutal hover:translate-x-[1px] hover:translate-y-[1px] hover:shadow-none focus-brutal"
                >
