...
const PaginationItem = React.forwardRef<HTMLButtonElement, PaginationItemProps>(
    ({ className, isActive, ...props }, ref) => (
        <button
            ref={ref}
            className={cn(
                "inline-flex h-11 w-11 items-center justify-center text-sm font-bold transition-brutal active:scale-[0.97] focus-brutal border-r-2 border-black last:border-r-0",
                isActive
                    ? "bg-main text-black"
