...
const Slider = ({ className, ref, ...props }: SliderProps) => (
    ...
    >
        <BaseSlider.Control className="flex w-full touch-none items-center select-none">
            ...
            <BaseSlider.Thumb className="block h-6 w-6 rounded-full border-2 border-black bg-main ring-offset-white focus-brutal disabled:pointer-events-none disabled:opacity-50" />
        </BaseSlider.Control>
    </BaseSlider.Root>
)
