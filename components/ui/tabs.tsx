...
>(({ className, ...props }, ref) => (
    <BaseTabs.Tab
        ref={ref}
        className={cn(
            "inline-flex min-h-11 items-center justify-center whitespace-nowrap rounded-base px-4 py-2 text-sm font-bold transition-colors focus-brutal disabled:pointer-events-none disabled:opacity-50 data-active:border-2 data-active:border-black data-active:bg-main data-active:text-black data-[state=inactive]:bg-transparent data-[state=inactive]:hover:bg-main/50 text-black",
            className
        )}
        {...props}
    />
