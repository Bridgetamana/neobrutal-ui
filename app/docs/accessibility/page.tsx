...
export default function AccessibilityPage() {
    return (
        <div className="space-y-8 text-black">
            <header>
                <h1 className="text-3xl font-semibold md:text-4xl">Accessibility</h1>
            </header>

            <section className="space-y-4">
                <p className="text-base text-black">
                    Components use semantic HTML and are built on{" "}
                    <a href="https://base-ui.com" className="underline font-semibold" target="_blank" rel="noopener noreferrer">Base UI</a>{" "}
                    for keyboard navigation, focus management, and screen reader support.
                </p>
            </section>

            <section className="space-y-4">
                <h2 className="text-2xl font-semibold">Focus Indicators</h2>
                <p className="text-base text-black">
